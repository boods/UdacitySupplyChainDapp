...
contract('SupplyChain', function(accounts) {
    ...
    function assetItemsAreEqual(item, expectedItem)
    {
        ...
        assert.equal(item.distributorID, expectedItem.distributorID, 'Error: Invalid item State');
        assert.equal(item.retailerID, expectedItem.retailerID, 'Error: Invalid item State');
        assert.equal(item.consumerID, expectedItem.consumerID, 'Error: Invalid item State');
    }
    ...
    async function fetchItemFromSupplyChange(supplyChain, upc, account = ownerID )
    {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        var item = await fetchItemFromSupplyChange(supplyChain, expectedItem.itemUPC);

        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lHarvested, 'Harvested');        
    })    
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lProcessed, 'Processed');                
    })    
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lPacked, 'Packed');              
    })    
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lForSale, 'ForSale');
    })    
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lSold, 'Sold');
    })    
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lShipped, 'Shipped');              
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lReceived, 'Received');              
    })    
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Verify the result set
        assetItemsAreEqual(item, expectedItem);
        truffleAssert.eventEmitted(lPurchased, 'Purchased');          
    })    
    ...
    it("Testing smart contract functions for fetchItemBuffer that allows anyone to fetch item details from blockchain", async() => {
        ...
        // to use my existig helper function 'fetchItemFromSupplyChange', which calls all three.
        const supplyChain = await SupplyChain.deployed()
        ...
        var item = await fetchItemFromSupplyChange(supplyChain, expectedItem.itemUPC, accounts[5] );
